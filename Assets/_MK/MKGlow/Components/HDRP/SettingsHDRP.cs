...
{
    internal sealed class SettingsHDRP : MK.Glow.Settings
    {
        public static implicit operator SettingsHDRP(MK.Glow.HDRP.MKGlow input)
        {
            SettingsHDRP settings = new SettingsHDRP();
